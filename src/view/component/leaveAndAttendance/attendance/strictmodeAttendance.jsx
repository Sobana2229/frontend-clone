function StrictmodeAttendance({formData, setFormData, handleRadioChange, handleChange}) {
    return (
            ...
            <div className="space-y-4">
                ...
                <>
                    <div className="flex items-center space-x-4">
                        <span className="text-sm text-gray-700 min-w-[80px]">Full day :</span>
                        <span className="text-sm text-gray-500">Duration of the shift</span>
                    </div>
                    <div className="flex items-center space-x-4">
                        <span className="text-sm text-gray-700 min-w-[80px]">Half day :</span>
                        <span className="text-sm text-gray-500">Half of the shift duration</span>
                    </div>
                </>
                ) : (
                <>
                    <div className="flex items-center space-x-4">
                        <span className="text-sm text-gray-700 min-w-[80px]">Full day <span className="text-red-500">*</span></span>
                        <input
                            type="time"
                            name="fullDayHours"
                    ...
                    <div className="flex items-center space-x-4">
                        <span className="text-sm text-gray-700 min-w-[80px]">Half day <span className="text-red-500">*</span></span>
                        <input
                            type="time"
                            name="halfDayHours"
...
export default StrictmodeAttendance;