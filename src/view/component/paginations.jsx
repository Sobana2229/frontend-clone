...
// Updated PaginationPages component to replace your existing one
function PaginationPages({ 
  ...
  // Support legacy totalPages prop
  const calculatedTotalPages = Math.ceil(totalRecords / rowsPerPage);
  
  const totalPages = legacyTotalPages || calculatedTotalPages;
