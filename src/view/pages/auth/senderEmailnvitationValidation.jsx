...
function SenderEmailnvitationValidation() {
    const navigate = useNavigate();
    const { token } = useParams();
    const { loading, checkValidationToken } = senderEmailPreferenceStoreManagements();
...
export default SenderEmailnvitationValidation;