...
import { templateFinalSettlementPayslipList } from "../../../../../../data/dummy";
...
import FinalSettlementTemplate from "../../../../component/pdfTamplates/finalSettlementPayslip/finalSettlementTemplate";

function FinalSettlementPayslip() {
    ...
    return (
        <div className="w-full h-full flex flex-col items-start justify-start space-y-4">
            <HeaderReusable title="Final Settlement Payslip" />
        
            <div className="w-[90%] grid grid-cols-4 gap-10 p-5">
                {templateFinalSettlementPayslipList?.map((el, idx) => {
                ...
                <div className="w-full h-full relative">
                    ...
                    <div className="w-full h-full pt-14">
                        <div className="w-full h-full flex items-start justify-center overflow-y-auto p-4">
                            {currentTamplates === "Final Settlement Template" && ( <FinalSettlementTemplate imgUrl={baseUrl + imgTamplateSetting} availableDetailTamplate={availableDetailTamplate} logoScale={logoScale} />)}
                        </div>
                    </div>
                </div>
            </Modal>     
...
export default FinalSettlementPayslip;
